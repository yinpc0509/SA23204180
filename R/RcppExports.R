...
gibbsSampler <- function(num_samples, n, a, b) {
    .Call(`_SA23204180_gibbsSampler`, num_samples, n, a, b)
}
...
gibbsC <- function(N, thin) {
    .Call(`_SA23204180_gibbsC`, N, thin)
}
...
vaccC <- function(age, female, ily) {
    .Call(`_SA23204180_vaccC`, age, female, ily)
}
